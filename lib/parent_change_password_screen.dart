...
class ParentChangePasswordScreen extends StatefulWidget {
  ...
  @override
  State<ParentChangePasswordScreen> createState() => _ParentChangePasswordScreenState();
}
...
class _ParentChangePasswordScreenState extends State<ParentChangePasswordScreen> {
  ...
  void _handleChangePassword() async {
    ...
    if (_firebaseService.selectedStudent == null) {
      _showError(Translations.get('Session expired. Please login again.', isUrdu));
      return;
    }
    ...
    String actualPassword = _firebaseService.selectedStudent?['parentPassword']?.toString() ?? '';
    if (currentPassword != actualPassword) {
      _showError(Translations.get('Current password is incorrect', isUrdu));
      return;
    }
    ...
    try {
      String adminId = _firebaseService.selectedStudent!['adminId'];
      String studentId = _firebaseService.selectedStudent!['docId'].toString();

      await _firebaseService.updateParentPassword(adminId, studentId, newPassword);
              ...
              child: Dialog(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.check_circle_outline, color: Color(0xFF00D4FF), size: 60),
                            ...
                            children: [
                              Center(
                                child: Container(
                                  ...
                                  child: const Icon(Icons.lock_outline, size: 70, color: Color(0xFF00D4FF)),
                                ),
                              ),
