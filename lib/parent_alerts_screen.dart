...
enum NotificationFilter { all, unread, reminders, feeAlerts }
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      var filteredDocs = allDocs.where((doc) {
                        ...
                        } else if (_currentFilter == NotificationFilter.feeAlerts) {
                          return data['iconType'] == 'fee';
                        }
                        return true;
                      }).toList();
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  _buildFilterChip('Fee Alerts', NotificationFilter.feeAlerts, isUrdu),
                                ],
                              ),
                            ),
                          ),
