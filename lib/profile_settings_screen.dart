...
class _ProfileSettingsScreenState extends State<ProfileSettingsScreen> {
                ...
                Row(
                  children: [
                    ...
                    if (isEditable) ...[
                      ...
                      const Icon(Icons.edit, size: 12, color: Color(0xFF2168F8)),
                    ],
                  ],
                ),
  ...
  void _showEditDialog(String title, String currentVal, Future<void> Function(String) onSave) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(hintText: Translations.get('Enter $title', isUrdu)),
        ),
        actions: [
                                    ...
                                    Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: _isUploadingLogo 
                                          ...
                                          : (_schoolLogoUrl != null && _schoolLogoUrl!.isNotEmpty)
                                            ? Image.network(_schoolLogoUrl!, fit: BoxFit.cover, 
                                                errorBuilder: (context, error, stackTrace) => const Icon(Icons.school, color: Color(0xFF2168F8), size: 40))
                                            : const Icon(Icons.school, color: Color(0xFF2168F8), size: 40),
                                      ),
                                    ),
                                    Positioned(
                                      bottom: 0,
                                      ...
                                      child: GestureDetector(
                                        onTap: _isUploadingLogo ? null : _changeLogo,
                                        child: Container(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: _isLoading 
                            ...
                            children: [
                               GestureDetector(
                                 onTap: () => _showEditDialog('School Name', _schoolName, (val) => _firebaseService.updateAdminProfile(schoolName: val)),
                                 child: _buildInfoRow(
                              ...
                              GestureDetector(
                                onTap: () => _showEditDialog('School Address', _address, (val) => _firebaseService.updateAdminProfile(schoolAddress: val)),
                                child: _buildInfoRow(
                              ...
                              _buildSettingRow(
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    if (_isBankDetailsMissing)
                                      const Icon(Icons.info_outline, color: Colors.red, size: 22),
                              ...
                              _buildSettingRow(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => const AdminSubscriptionDetailsScreen()),
                                  );
                                },
                              ),
                            ],
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                                ...
                                trailing: Switch(
                                  ...
                                  onChanged: (value) async {
                                    if (value == false) {
                                      ...
                                      _showNotificationConfirmDialog(context, isUrdu);
                                    } else {
                                      // Turn ON immediately
                                      setState(() {
                                        isNotificationEnabled = true;
                                      });
                                      await _firebaseService.updateNotificationSettings(true);
                                    }
                                  },
                              ...
                              StreamBuilder<bool>(
                                stream: _firebaseService.hasUnreadParentMessagesStream(_firebaseService.currentAdminId ?? ''),
                                builder: (context, snapshot) {
                                  ...
                                  return _buildSettingRow(
                                    ...
                                    showDot: hasUnread,
                                    onTap: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => const AdminParentChatListScreen()));
                                    },
                                  );
                                },
                              ),
                              StreamBuilder<bool>(
                                stream: _firebaseService.hasUnreadForAdminStream(_firebaseService.currentAdminId ?? ''),
                                builder: (context, snapshot) {
                                  bool hasUnread = snapshot.data ?? false;
                                  return _buildSettingRow(
                                    Icons.chat_rounded,
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () => _showLogoutConfirmation(context, isUrdu),
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            const SizedBox(width: 10),
            Expanded(child: Text(Translations.get('Disable Notifications?', isUrdu))),
          ],
        ),
        content: Text(
          Translations.get('If you toggle the notifications to OFF you won\'t be able to recieve push notifications.', isUrdu),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text(Translations.get('Turn Off', isUrdu), style: const TextStyle(color: Colors.white)),
          ),
        ],
      ),
    );
