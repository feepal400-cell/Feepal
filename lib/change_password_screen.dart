...
class ChangePasswordScreen extends StatefulWidget {
  ...
  const ChangePasswordScreen({super.key, this.isLoggedIn = false});
...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  void _performAutoLogout(bool isUrdu, BuildContext context) {
                ...
                children: [
                  ...
                  Text(
                    widget.isLoggedIn 
                        ...
                        : Translations.get('Password reset successfully', isUrdu),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (widget.isLoggedIn) {
                          _performAutoLogout(isUrdu, context);
                        } else {
                          // Redirect to login directly without "Login again" popup
                          Navigator.pushAndRemoveUntil(
                            context,
                            MaterialPageRoute(builder: (context) => const UserLoginScreen()),
                            (route) => false,
