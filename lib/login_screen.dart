            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _buildChangelogItem(Icons.web, 'Integrated FeePal Website with the FeePal App.'),
                  _buildChangelogItem(Icons.subscriptions_outlined, 'The subscription and resubscription methods work properly.'),
                  _buildChangelogItem(Icons.document_scanner_outlined, 'Implemented OCR Verification System.'),
                  const SizedBox(height: 20),
                  SizedBox(
                    width: double.infinity,
                    height: 50,
